...
# presence / absence 
comp_peixes<-ifelse (comp_peixes>0,1,0)
comp_bentos<-ifelse (comp_bentos>0,1,0)
# run function
FD_obs_data_fish <- function_FD_fish (comp_peixes, fish_traits_ord)
FD_obs_data_benthos <- function_FD_fish (comp_bentos, bent_traits_ord)

# save it
dir.create("output_no_resampling")
save (FD_obs_data_fish, file=here("output_no_resampling","FD_obs_data_fish.RData"))
save (FD_obs_data_benthos, file=here("output_no_resampling","FD_obs_data_benthos.RData"))

#cor (FD_obs_data_fish$Fdindexes$FRic, 
#     FD_obs_data_benthos$Fdindexes$FRic)
