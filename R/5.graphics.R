...
# -----------------------------------------
## correlation between variables (Fig. S2.1)
...
pdf(here ("output","vectorized", "fig2_SST.pdf"),width=7,height=4)
color_scheme_set("blue")
mcmc_areas(posterior, pars = c("b_logEstRich_BO2_tempmean_ss_std",         
                               "b_logEstRichbenthos_BO2_tempmean_ss_std", 
