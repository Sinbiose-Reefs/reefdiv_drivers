...
# load estimates 
load(here("output_no_resampling_sensitivity", "FD_obs_data_fish.RData"))
load(here("output_no_resampling_sensitivity", "FD_obs_data_benthos.RData"))
...
load (here ("output_no_resampling_sensitivity", "MCMC_runs_multivariate_rarefied_no_aut.RData"))
...
pdf(here ("output_no_resampling_sensitivity","fig2_temp.pdf"),width=7,height=4)
...
#sampling area
pdf(here ("output_no_resampling_sensitivity","fig2_samplingarea.pdf"),width=7,height=4)
...
model <- brms::brm(
  mvbind(logSR, logFRic, logFEve, logFDiv, logSR_benthos, logFRic_benthos, logFEve_benthos, logFDiv_benthos) ~ sst+samp.area,
