...
save (comp_peixes,# composition per site (not rarefied)
      ...
      file = here("output_sensitivity", "random_composition_fish.RData"))
...
save (comp_bentos,
      ...
      file = here("output_sensitivity", "random_composition_bentos.RData"))
...
save (covariates_site , ### dados de covariaveis das bases de dados
      ...
      file=here ("output_sensitivity","env_data.RData"))
